import { S as Subscribable, p as pendingThenable, j as resolveQueryBoolean, s as shallowEqualObjects, k as resolveStaleTime, n as noop, e as environmentManager, i as isValidTimeout, t as timeUntilStale, u as timeoutManager, c as focusManager, f as fetchState, h as replaceData, d as notifyManager, m as shouldThrowError, z as useQueryClient, x as useI18n } from "./router-Bmf9N68K.js";
import { S as reactExports, J as jsxRuntimeExports } from "./server-CmVoqoVv.js";
import { l as logo } from "./Navbar-e_eBN0rx.js";
...
function Footer() {
  const { t } = useI18n();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-card mt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-12 flex flex-col items-center gap-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "", className: "h-14 w-14 rounded-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display tracking-[0.3em] uppercase", children: t("brand") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider w-32" }),
